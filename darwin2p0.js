...
deez: ['Darwin Deez wrote the anthem of Indie Google+, "Radar Detector." That is his sole redeeming quality.','Darwin Deez is who I\'m named after.', 'Darwin Deez is just as crazy in person as you\'d probably expect.', 'Darwin Deez tries really hard to be a 16 year old hipster. The truth is, he\'s got the douche factor down.', 'Should you go to that Deez show near you? Well, is it free? If not, then no.', 'When invited to karaoke, Darwin Deez declined citing an insecurity about his singing voice. This was 20 minutes before the beginning of his set.'],
